...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('a56ac3e0-aef8-48b9-b55b-844b3fa77056/sounds/use.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('a56ac3e0-aef8-48b9-b55b-844b3fa77056/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('a56ac3e0-aef8-48b9-b55b-844b3fa77056/models/Face_Access_Card.glb'))
    key.addComponent(
           new OnPointerDown(() => {
