...
// Sound
const missSound = new Sound(new AudioClip("arcade-games/sounds/miss.mp3"))

// Translate ball based on its direction property
//class BallTranslatorSystem {
export class BallTranslatorSystem {
...
//engine.addSystem(new BallTranslatorSystem(), 1)//moved to init
