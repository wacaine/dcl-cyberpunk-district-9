...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('274df603-dd2b-4a32-b2a0-c4ad758cb037/sounds/use.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('274df603-dd2b-4a32-b2a0-c4ad758cb037/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('274df603-dd2b-4a32-b2a0-c4ad758cb037/models/Fingerprint_Access_Card.glb'))
    key.addComponent(
           new OnPointerDown(() => {
