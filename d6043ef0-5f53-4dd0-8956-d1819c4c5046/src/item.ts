...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('d6043ef0-5f53-4dd0-8956-d1819c4c5046/sounds/use.mp3')
  equipClip = new AudioClip('d6043ef0-5f53-4dd0-8956-d1819c4c5046/sounds/KeyEquip.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('d6043ef0-5f53-4dd0-8956-d1819c4c5046/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('d6043ef0-5f53-4dd0-8956-d1819c4c5046/models/Silver_Key_Genesis.glb'))
    key.addComponent(
      new OnPointerDown(
        () => {
