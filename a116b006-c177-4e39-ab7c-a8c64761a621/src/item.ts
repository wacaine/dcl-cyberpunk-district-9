...
export default class Door implements IScript<Props> {
  Clip = new AudioClip("a116b006-c177-4e39-ab7c-a8c64761a621/sounds/Telephone_01.mp3")
...
toggle(entity: Entity) {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    car.addComponent(new GLTFShape("a116b006-c177-4e39-ab7c-a8c64761a621/models/Phone_Booth.glb"))
