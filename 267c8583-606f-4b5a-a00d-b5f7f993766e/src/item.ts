...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('267c8583-606f-4b5a-a00d-b5f7f993766e/sounds/use.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('267c8583-606f-4b5a-a00d-b5f7f993766e/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('267c8583-606f-4b5a-a00d-b5f7f993766e/models/Yellow_Access_Card.glb'))
    key.addComponent(
           new OnPointerDown(() => {
