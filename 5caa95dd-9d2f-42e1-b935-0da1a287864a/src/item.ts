...
export default class Lamp implements IScript<Props> {
  clip = new AudioClip('5caa95dd-9d2f-42e1-b935-0da1a287864a/sounds/NeonTube.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    let offModel = new GLTFShape('5caa95dd-9d2f-42e1-b935-0da1a287864a/models/Closed_Sign.glb')
    lampOff.addComponent(offModel)

    const lampOn = new Entity(host.name + '-on')
    lampOn.setParent(host)
    lampOn.addComponent(new Transform())
    let onModel = new GLTFShape('5caa95dd-9d2f-42e1-b935-0da1a287864a/models/Open_Sign.glb')
