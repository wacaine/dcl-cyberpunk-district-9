...
export default class Button implements IScript<Props> {
  clip = new AudioClip('6ecf36b9-d21a-4767-b945-4b45cd53c537/sounds/Helicopter_Loop.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    transmitter.addComponent(new GLTFShape('6ecf36b9-d21a-4767-b945-4b45cd53c537/models/Helicopter_Anim.glb'))
