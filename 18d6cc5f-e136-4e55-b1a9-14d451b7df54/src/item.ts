...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('18d6cc5f-e136-4e55-b1a9-14d451b7df54/sounds/use.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('18d6cc5f-e136-4e55-b1a9-14d451b7df54/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('18d6cc5f-e136-4e55-b1a9-14d451b7df54/models/Blue_Access_Card.glb'))
    key.addComponent(
      new OnPointerDown(
        () => {
